...
/*
var q = localStorage.OSHUA_ShouZiMuTianKong_QUESTION;
*/
...
for (var i = 273; i < (qlist.length+274); i++) {
(function(i){
...
setTimeout("document.getElementById(\"qlistsa\").innerHTML = window.aaa;document.getElementById(\"mainn\").innerHTML = \"你好呀, 欢迎来到[首字母填空附加专场]! 现有习题\"+qlist.length+\"道(从274开始算,1-273见普通版), 你已经完成了\"+alltimuwancheng+\"道, 真棒!<br>测试进行中, 部分习题答案批改错误, 欢迎反馈!存档等功能已上线!<br>>现在看上去非常不爽因为还没有仔细写css,未来会写的啊<<br>\";", 500);
